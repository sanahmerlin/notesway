          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col gap-3 pt-2">
              <a
                ...
                className="inline-flex items-center gap-3 px-5 py-3 rounded-sm border border-primary/30 text-sm text-foreground font-light hover:border-primary hover:shadow-[0_0_15px_hsl(41_46%_57%/0.15)] hover:-translate-y-0.5 transition-all duration-300"
              >
