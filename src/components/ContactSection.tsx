    ...
    <section id="contact" className="section-padding bg-muted/50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <p className="brand-name text-xs text-primary mb-4 tracking-[0.4em]">REACH OUT</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-display text-lg font-semibold text-foreground mb-1">Our Location</h3>
                <p className="text-body text-sm">Kumbalanghi, Kochi, Kerala, India</p>
              </div>
            </div>
